    ...
    <div class="form-container">
        ...
        <spring:form action="updateEmployee" method="post"
           ...
           <div class="input-container">
                <i class="fas fa-phone-alt"></i> <input type="text" name="id"
                    placeholder="ID" readonly="readonly" required value="<%=employee.getId() %>">
            </div>
            <div class="input-container">
                <i class="fas fa-user"></i> <input type="text" name="name"
                    placeholder="Name" required value="<%=employee.getName()%>">
            </div>
            <div class="input-container">
                <i class="fas fa-phone-alt"></i> <input type="text" name="mobile"
                    placeholder="Mobile" required value="<%=employee.getMobile() %>">
            </div>
            <div class="input-container">
                <i class="fas fa-money-check-alt"></i> <input type="text"
                    name="salary" placeholder="Salary" required value="<%=employee.getSalary()%>">
            </div>
            <div class="input-container">
